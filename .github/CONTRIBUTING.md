...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
   ...
   git clone https://github.com/<your-username>/ethjs-format.git
...
**DESIGN NOTE**: ethjs-format follows the UNIX programming philosophy. Please consider this before contributing, keep your commits/modules concise and to the point.
